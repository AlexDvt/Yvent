...
module.exports = __webpack_require__(/*! C:\Users\orian\event\src\main.ts */"zUnb");
...
const routes = [
    ...
    {
        path: 'free-event',
        loadChildren: () => __webpack_require__.e(/*! import() | free-event-free-event-module */ "free-event-free-event-module").then(__webpack_require__.bind(null, /*! ./free-event/free-event.module */ "iqTf")).then(m => m.FreeEventPageModule)
    },
];
